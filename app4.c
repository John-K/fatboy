...
#include <stdio.h>
#include <string.h>
#include "elmchan/src/ff.h"         /* Declarations of sector size */
#include "elmchan/src/diskio.h"     /* Declarations of device I/O functions */
...
int main (int argc, char* argv[])
{
    ...
    if (argc != 2) {
        printf("Usage: fatboy <image>\n");
        return -1;
    }

    if (0 != fatboy_set_image(argv[1])) {
        return -1;
    }
